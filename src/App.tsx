  ...
  return (
    <Layout>
      ...
      >
        ...
        <Link className="btn-one" to="/shop">Shop Trees</Link>
      </header>
      <section className="featured-trees-sec">
        ...
        <div className="featured-trees-container">
          <div className="tree-card">
            ...
            <Link className="btn-one" to="/shop">Buy Now</Link>
          </div>
          <div className="tree-card">
            <img src="https://picsum.photos/200" alt="random pic"></img>
          ...
          <div className="tree-card">
            ...
            <p>Mi ipsum faucibus vitae aliquet. Nunc mattis enim ut tellus elementum.</p>
            <Link className="btn-one" to="/shop">Buy Now</Link>
          </div>
        </div>
      </section>
      <section className="testimonial-sec">
        ...
        <div className="testimonial-quote-container">
          <figure>
            <blockquote>
              <p>Tree Shoppe knows what i want. Fast growing trees sent to me in 24 hours. Wont buy from anyhere else now!</p>
            </blockquote>
